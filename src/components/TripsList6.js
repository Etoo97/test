...
const TripsList6 = () => {
    ...
    return (
        <ScrollView
            style={{ bottom: 25, marginVertical: 25 }}>
            <View
                style={{
                    flexDirection: 'row',
                ...
                <TouchableOpacity style={styles.foodCon} onPress={() => { navigation.navigate('AddCard') }}>
                    <View >
                        <View>
                            <View style={{ padding: 12 }}>
                             <Image source={ImageTripsList.Cabray} style={styles.foodItem} />
                                <View style={styles.titleBox1}>
                                    <Text style={styles.title1}>20% <Text style={{ fontSize: 10 }}>off</Text></Text>
                                </View>
                            </View>
                ...
                <TouchableOpacity style={styles.foodCon} onPress={() => { navigation.navigate('AddCard') }}>
                    <View >
                        <View>
                            <View style={{ padding: 12 }}>
                            <Image source={ImageTripsList.Glaxsy} style={styles.foodItem} />
                                <View style={styles.titleBox1}>
                                    <Text style={styles.title1}>20% <Text style={{ fontSize: 10 }}>off</Text></Text>
                                </View>
                            </View>
